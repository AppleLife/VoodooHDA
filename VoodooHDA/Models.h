...
#define HDA_INTEL_SCPT				HDA_MODEL_CONSTRUCT(INTEL, 0x1e20)
...
#define HDA_NVIDIA_GTX_570			HDA_MODEL_CONSTRUCT(NVIDIA, 0x0e09)
...
#define HDA_ATI_BARTS				HDA_MODEL_CONSTRUCT(ATI, 0xaa88)
